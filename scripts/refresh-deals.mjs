...
- REGIONAL HONESTY: for chains that do not operate in most U.S. states (El Pollo Loco, Salad and Go, The Halal Guys, Tijuana Flats, Rock N Roll Sushi, Sushi Maki, Island Fin Poke, and every grocery chain except Walmart and Whole Foods Market), NEVER write region "National" - state the real footprint instead, e.g. "West Coast", "South Florida", or "FL & Southeast" for Tijuana Flats. These regional chains are never marked best.
