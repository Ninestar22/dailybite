...
- GROCERY (owner request, 2026-08-20): good-value deals count even when they come from a grocery store. Publix (Florida and the Southeast: FL, GA, AL, SC, NC, TN, VA, KY) is approved for its in-store prepared-food counter. Its standing deal is $5 Sushi Wednesday: select fresh-made rolls (spicy tuna, California, spicy shrimp, cream cheese/Philadelphia-style, vegetable; selection varies by store) for $5 each every Wednesday at stores with a sushi counter, regular price $6 to $10. EXCEPTION to the no-recurring rule for this deal ONLY: list it ON Wednesdays only, brand "Publix", cat "Sushi", region "FL & Southeast", url https://www.publix.com/locations, never "best" (regional). On any day, also include other verified Publix prepared-food deals with a stated price (sushi, deli, hot bar) when you find them on publix.com or a reputable tracker. Do not add other grocery chains unless they are added to the approved list.
...
- REGIONAL HONESTY: for chains that do not operate in most U.S. states (Whataburger, Del Taco, El Pollo Loco, Salad and Go, Jack in the Box, In-N-Out, The Halal Guys, Tijuana Flats, Publix), NEVER write region "National" - state the real footprint instead, e.g. "TX and the South", "West Coast", or "FL & Southeast" for Tijuana Flats. These regional chains are never marked best.
