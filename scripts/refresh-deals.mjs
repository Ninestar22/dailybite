...
const PROMPT = `You maintain "DailyBite", a page listing the best current U.S. HEALTHY food deals: fast-casual bowls and salads, smoothies and juice, sushi and poke, Mediterranean, grilled chicken, and grocery prepared-food counters.

TODAY is ${TODAY} (US Eastern). Every deal must be claimable today; a day-of-week special may only appear if its day is ${WEEKDAY}.

Use web search to find TODAY'S real, currently-active in-app and publicly claimable deals ONLY from this approved list of quality and healthy chains: Sweetgreen, CAVA, Chipotle, Chick-fil-A, Panera Bread, Potbelly, Noodles & Company, Just Salad, Qdoba, Naf Naf Grill, Smoothie King, Tropical Smoothie Cafe, Jamba, Salad and Go, El Pollo Loco, The Halal Guys, Naz's Halal Food, Shah's Halal Food, Tijuana Flats, Kura Sushi, Sarku Japan, Rock N Roll Sushi, Sushi Maki, Pokeworks, Island Fin Poke, Pollo Tropical, Rubio's Coastal Grill, Waba Grill, Pei Wei, Teriyaki Madness, Honeygrow, Playa Bowls, Nekter Juice Bar, Jason's Deli, McAlister's Deli, Chicken Salad Chick, Taziki's Mediterranean Cafe, Chopt Creative Salad Co., Saladworks, Salata Salad Kitchen, Crisp & Green, Bibibop Asian Grill, Cafe Zupas, Clean Juice, Robeks, Luna Grill, Modern Market Eatery, Dig, Bolay, Fresh Kitchen, Little Greek Fresh Grill, The Great Greek Mediterranean Grill, Clean Eatz, Vitality Bowls, Everbowl, Rush Bowls, Pressed Juicery, Flame Broiler, Roti Modern Mediterranean, Garbanzo Mediterranean Fresh, Pita Pit, Newk's Eatery, Subway, and Starbucks - plus national platform promos from DoorDash, Uber Eats, and Grubhub, and the prepared-food counters of these grocery chains (see the GROCERY rule): Publix, Sprouts, Kroger and its banners (Fred Meyer, Ralphs, Fry's, King Soopers, Smith's, QFC), Harris Teeter, Safeway, Albertsons, Vons, Jewel-Osco, ACME Markets, Shaw's, Tom Thumb, Randalls, Food Lion, Lowe's Foods, Wegmans, H-E-B, Hy-Vee, Meijer, Giant Eagle, Whole Foods Market, Winn-Dixie, ShopRite, Stop & Shop, Giant Food, Giant Eagle, and Walmart. Prefer official brand sources and reputable deal trackers (Brand Eating, EatDrinkDeals, The Krazy Coupon Lady).
...
LIST SIZE (owner request, 2026-08-24): aim for 12 to 18 deals every day: a 6-deal day is a weak page. If the roundups leave the list short, spend the remaining search budget going chain by chain through the approved list ("Sweetgreen promo code", "CAVA deal this week", "Bolay app deal", "El Pollo Loco app deals", "Qdoba coupon") until the list fills out. Standing value menus with stated prices (Panera $4.99 Mix & Match, Subway Sub of the Day, Noodles Delicious Duo) count and are worth re-verifying daily. Never pad with vague, expired, or dollar-less offers to hit the number: stated-dollars quality first, then quantity.

WEEKEND DEPTH (owner report, 2026-08-30: a Sunday list left a Florida visitor only 3 claimable deals): weekend lists run thin because weekday roundups go stale. On Saturday and Sunday, spend extra searches on weekend-specific angles: "weekend food deals", "[chain] weekend promo code", flash codes posted Friday-Sunday (Chipotle and Panera run these often), and app-offer tabs of the healthy roster. Also remember FLORIDA VISITORS specifically (the owner is one): verified deals from FL-footprint chains (Tijuana Flats, Pollo Tropical, Publix, Playa Bowls, Island Fin Poke, Chicken Salad Chick, Bolay, Fresh Kitchen, Little Greek Fresh Grill) are extra valuable because national-only lists leave FL thin - search at least one of them every weekend run.
...
- APPROVED BRANDS ONLY: deals may come ONLY from the approved list above. NEVER include any other restaurant - no McDonald’s, Burger King, KFC, Taco Bell, Wendy’s, Popeyes, Sonic, Arby’s, Dairy Queen, Domino’s, Pizza Hut, Papa Johns, Little Caesars, Jack in the Box, Whataburger, Del Taco, IHOP, Denny’s, Krispy Kreme, Insomnia Cookies, TCBY, Five Guys, Shake Shack, Wingstop, Chili's, Applebee's, Zaxby's, Raising Cane's, Culver's, In-N-Out, Jersey Mike's, or any other burger, wing, fried-chicken, pizza, or dessert chain, regardless of how good their deal looks. (Five Guys, Shake Shack, Wingstop and Chili's were REMOVED from the roster on 2026-09-07: the site is a HEALTHY food deals site and even a seemingly-unhealthy chain undercuts that.) The owner eats healthy and this site reflects that.
...
- GROCERY (owner request, 2026-08-20): the best value often comes from a grocery store's prepared-food counter, so the approved grocery chains above count as brands. Only READY-TO-EAT prepared food qualifies (sushi, poke, deli and hot-bar meals, rotisserie chicken, fresh pizza, salads, meal deals): never packaged groceries, never BOGO shelf items. Evidence must be the store's own site, weekly ad, press release or FAQ, or the official page/social account of the sushi vendor that runs its counter (AFC, Zenshi, Snowfox, Oumi, Hissho); one viral post is not evidence. Many grocers run a weekly SUSHI DAY: list it ON that day only (EXCEPTION to the no-recurring rule, for grocery chains only), with the weekday named in the title or description, cat "Sushi" (or "Deli"/"Grocery" for other counters). Known sushi days to re-verify every week: Publix $5 Sushi Wednesday (FL & Southeast, no card needed), Sprouts Sushi Wednesday (select Oumi rolls $5, most markets, no card needed), Kroger-family Sushi Wednesday (Snowfox rolls, $6 since 2026, "Wednesday Only" SKUs on kroger.com), Safeway/Albertsons Sushi Wednesday ($5.99 to $6 Zenshi rolls) and $5 Friday (sushi and 8-piece chicken in many divisions), Harris Teeter $5 Friday sushi (VIC card, some markets), Food Lion $5 Sushi Wednesday (Hissho rolls, Mid-Atlantic & Southeast), Lowes Foods $4.99 Sushi Wednesday (NC & SC), Weis Markets $5 Sushi Wednesday (Snowfox rolls, PA/MD/NY/NJ/DE/WV/VA), Hannaford $5 Sushi Wednesday (Wago California, Spicy California and Vegan rolls, Northeast), Dierbergs $6 Sushi Tuesday (St. Louis), Fresh Thyme Sushi Thursday (Midwest; confirm this week's price before listing), Island Fin Poke Topping Tuesday (free premium topping with any bowl, official Daily Specials page). All of these are injected by the build on their day, so do NOT spend searches re-verifying them; spend those searches on limited-time sushi and poke promos instead. MORE WEEKLY GROCERY DEALS (owner request 2026-09-08, each source-checked that day; re-verify and list ON its day): Hy-Vee Sushi Wednesday (select Nori Sushi rolls $6, Midwest, participating stores) and Hy-Vee Sushi Friday (buy one Nori roll, get one 50% off); H-E-B Sushi Wednesday and $7 Saturday (select Sushiya rolls $7, Texas); Meijer Sushi Wednesday (select rolls $5.99, Midwest); ShopRite $5.99 Sushi Wednesday (NJ, NY, PA, CT, DE, MD; store-run); Stop & Shop $5.99 Red Label Sushi Wednesday (Northeast); Giant Food Sushi Wednesday (DC, MD, VA, DE: reported around $5 - confirm in this week's ad or a store post before listing); Giant Eagle / Market District Sushi Wednesday (select sushi about $5, some stores 4-7 PM only, PA/OH/WV/MD/IN - confirm before listing); Publix Sub of the Week ($2 off one featured whole deli sub, changes with the weekly ad, listed on publix.com/mc/order-ahead/weekly-specials; cat "Deli", any day). Search at least one of these counters by name every run on top of the day's known specials, and on Wednesdays and Fridays spend an extra search on "[grocery chain] sushi Wednesday" or "$5 Friday" for any Midwest or Northeast chain not yet covered: grocery sushi days are the most reliable healthy value the site has. Prices differ by division: state the price you verified and the real footprint in "region" (e.g. "Texas only", "Northeast", "FL & Southeast", "Select states"); only Walmart and Whole Foods Market may be "National". A FREE store loyalty card or app (Kroger Plus, VIC, for U, Hy-Vee Fuel Saver) is acceptable for grocery deals: say "free [card] required" in the description. Amazon Prime perks at Whole Foods and warehouse clubs (Costco, Sam's, BJ's) are paid memberships and stay banned. Grocery deals are never "best" unless national. Spend at least 2 searches on grocery counters every day: one roundup ("grocery store sushi deals ${WEEKDAY}" or "grocery prepared food deals this week") plus the day's known specials (Wednesday: Publix, Sprouts, Kroger-family and Safeway sushi; Friday: Safeway/Albertsons $5 Friday and Harris Teeter $5 Friday sushi; other days: Walmart/Wegmans/H-E-B meal deals). WARNING (verified 2026-08-24): Whole Foods' Tuesday and Friday "Days of Deals" (rotisserie chicken, $12 pizza, BOGO sushi) are Amazon Prime-member-only and therefore BANNED under the no-paid-subscription rule: never list them. Trader Joe's runs no sales or promos at all (everyday-price policy): never list Trader Joe's.
- HEALTHY REPLACEMENTS (owner request, 2026-09-07, replaces the old casual-dining rule): the approved list now also includes Bolay (Florida), Fresh Kitchen (Florida), Little Greek Fresh Grill (FL & Southeast), The Great Greek Mediterranean Grill (Select states), Clean Eatz (Southeast & Midwest), Vitality Bowls, Everbowl and Rush Bowls (acai and grain bowls, Select states), Pressed Juicery (Select states), Flame Broiler (CA & Southwest), Roti Modern Mediterranean (Chicago & DC), Garbanzo Mediterranean Fresh (Select states), Pita Pit (Select states), and Newk's Eatery (South). These are genuinely healthy bowl, Mediterranean, acai and juice chains with frequent app promos and stated-price bundles: include their deals whenever verifiable and rotate 2-3 of them into the chain-by-chain sweep each day (the Florida ones on weekends: see WEEKEND DEPTH). All are REGIONAL (see REGIONAL HONESTY): never label them "National" and never mark them best. Noodles & Company (promo codes and Delicious Duos) stays on the roster and is worth a search on every refresh.
...
- DELIVERY-APP DEALS (owner decision, 2026-09-03, expands the old pickup-only rule): DoorDash, Uber Eats, and Grubhub carry some of the most valuable deals (40-50% off events, restaurant BOGOs run through the app). Include them when ALL of these hold: (1) PUBLICLY ANNOUNCED by the platform or the restaurant (platform newsroom, blog or help page, restaurant newsroom or official social account, or a reputable deal tracker citing one) - never a personalized in-app offer that only some accounts see; (2) open to EVERY user including existing customers - never first-order, new-customer or referral promos, and never DashPass / Uber One / Grubhub+ member perks; (3) national, or the real region stated honestly; (4) either a platform-wide promo (brand = the platform name, cat "Pickup" or "Delivery") or a deal for a chain on the approved list (brand = the chain; McDonald's-class chains stay banned no matter the channel). Set the additive fields "via" (the platform name exactly: "Uber Eats", "DoorDash" or "Grubhub") and "fulfillment" ("pickup", "delivery" or "pickup or delivery"). For DELIVERY deals, est_savings must be NET of typical fees: assume about $6 of delivery and service fees plus roughly 15% menu markup unless the promo waives them, so 40% off a $30 order is about $12 minus $6 in fees = 6, not 12; pickup deals take no deduction. Spend 1-2 searches per run on these ("DoorDash promo this week", "Uber Eats deals newsroom", "[approved chain] Uber Eats BOGO"). The title must still state the dollars or percent.
...
- NO EVERYDAY MENUS FROM PANERA, SUBWAY OR NOODLES & COMPANY (owner decision, 2026-09-21: they showed up every single day and stopped feeling like deals): never list Panera's Mix & Match / Value Duets value menu, Subway's Sub of the Day, Meal of the Day or Fresh Value Menu, or Noodles & Company's Delicious Duos, and never list anything from these three chains with "expires":"Ongoing". List these chains ONLY for a genuinely limited-time promotion or promo code with a stated end date (a BOGO week, a dated 2-for-$12, a one-day code). Do not spend searches re-verifying their standing menus; spend them on other approved chains instead. The build drops these entries in code, so listing them only wastes a slot.
...
{"deals":[{"brand":"...","cat":"Burgers|Chicken|Mexican|Pizza|Coffee|Cafe|...","color":"#rrggbb","ic":"M","deal":"...","desc":"one sentence","tags":["free","app"],"value":1-5,"expires":"e.g. Through July 20 | This week | Ongoing","url":"https://...","best":true,"est_savings":4,"via":"Uber Eats","fulfillment":"pickup"}]}`;
...
function salvage(deals) {
  ...
  // via / fulfillment (additive feed fields, 2026-09-03, delivery-app deals): optional.
  // "via" must be one of the three platforms exactly; "fulfillment" one of three values.
  // Anything else is STRIPPED, never fatal - like est_savings.
  const VIA_OK = ["Uber Eats", "DoorDash", "Grubhub"];
  const FUL_OK = new Set(["pickup", "delivery", "pickup or delivery"]);
  deals.forEach(d => {
    if (d && "via" in d) {
      const v = String(d.via || "").trim().toLowerCase();
      const hit = VIA_OK.find(p => p.toLowerCase() === v);
      if (hit) d.via = hit; else { delete d.via; console.error(`Stripped invalid via on ${(d && d.brand) || "unknown deal"}`); }
    }
    if (d && "fulfillment" in d) {
      const f = String(d.fulfillment || "").trim().toLowerCase();
      if (FUL_OK.has(f)) d.fulfillment = f; else { delete d.fulfillment; console.error(`Stripped invalid fulfillment on ${(d && d.brand) || "unknown deal"}`); }
    }
  });
