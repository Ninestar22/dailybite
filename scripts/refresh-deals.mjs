...
- GOLDEN STANDARD BRANDS: Chipotle and Chick-fil-A set the quality bar for this site. On EVERY refresh, search these two chains FIRST and include their best currently-active deal whenever one exists. EXCEPTION for these brands plus Tropical Smoothie Cafe (owner decision 2026-08-30, after personally listing the $6 acai Tropic Rewards offer): deals requiring a FREE app account (Chipotle Rewards / Chick-fil-A One / Tropic Rewards) ARE allowed - state "free account required" plainly in the description. Paid memberships remain banned everywhere, and the membership ban still applies to every other chain. Never invent or stretch a deal if nothing qualifies today.
